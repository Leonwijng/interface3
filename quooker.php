...
<body class="bg-[#D9A49C]">
        ...
        <div class="container mx-auto max-w-6xl">
            <div class="flex flex-col md:flex-row gap-8 md:gap-12">
                ...
                <div class="md:w-1/2 bg-white p-6 rounded-xl shadow-lg">
                    <img id="mainImage" src="images/quooker/quooker1.png" class="w-full h-auto object-contain rounded-lg transition-opacity duration-300">
                    <div class="flex gap-4 mt-6">
                        <div onclick="changeImage('images/quooker/quooker1.png')" class="thumbnail w-1/4 border-2 border-gray-200 rounded-lg p-1 cursor-pointer active">
                            <img src="images/quooker/quooker1.png" class="w-full h-auto">
                        </div>
                        <div onclick="changeImage('images/quooker/quooker2.png')" class="thumbnail w-1/4 border border-gray-200 rounded-lg p-1 cursor-pointer">
                            <img src="images/quooker/quooker2.png" class="w-full h-auto">
                        </div>
                        <div onclick="changeImage('images/quooker/quooker3.png')" class="thumbnail w-1/4 border border-gray-200 rounded-lg p-1 cursor-pointer">
                            <img src="images/quooker/quooker3.png" class="w-full h-auto">
                        </div>
                        <div onclick="changeImage('images/quooker/quooker4.png')" class="thumbnail w-1/4 border border-gray-200 rounded-lg p-1 cursor-pointer">
                            <img src="images/quooker/quooker4.png" class="w-full h-auto">
                        </div>
                    </div>
                </div>
                ...
                <!-- Product Details -->
                <div class="md:w-1/2">
                    <h1 class="text-3xl md:text-4xl font-bold text-white mb-2">QUOOKER 22+FRCHR</h1>
                    ...
                    <p class="text-2xl font-bold text-white mb-6">€599</p>
                    ...
                    <div class="bg-white bg-opacity-20 backdrop-blur-sm rounded-xl p-6 mb-6">
                        ...
                        <p class="text-white mb-4">
                            Quooker Fusion Round chroom met C-uitloop inclusief COMBI+ reservoir voor koud, warm en kokend water uit dezelfde kraan. Door een (dubbel)druk-draai bedieningsknop is de kraan veilig voor kinderen. Na aansluiting op de warm en koud waterleiding geeft de COMBI+ boiler 7 liter kokend water van 100°C en onbeperkt warm water.
                        </p>
                    ...
                    <div class="bg-white bg-opacity-20 backdrop-blur-sm rounded-xl p-6">
                        ...
                        <button onclick="goToCheckout()" id="checkoutBtn" class="w-full bg-green-600 text-white hover:bg-green-800 font-bold py-3 px-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 flex items-center justify-center">
                            <span id="checkoutBtnText">Bestelling Voltooien</span>
                            <svg id="checkoutSpinner" class="hidden ml-2 h-5 w-5 animate-spin text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            ...
            <div class="p-6">
                ...
                <div class="flex flex-col md:flex-row gap-8">
                    ...
                    <div class="md:w-1/3 bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="flex items-center mb-4">
                            <img id="checkoutImage" src="images/quooker/quooker1.png" class="w-16 h-16 object-cover rounded-lg mr-3 hover:animate-spin">
                            <div>
                                <h4 class="font-medium" id="checkoutProduct">Quooker 22+FRCHR</h4>
                                <p class="text-gray-600">Aantal: <span id="checkoutQuantity">1</span></p>
                                <p class="font-bold">€<span id="checkoutPrice">599,99</span></p>
                            </div>
                        </div>
                        <div class="border-t border-gray-200 pt-4">
                            <div class="flex justify-between mb-2">
                                <span>Subtotaal:</span>
                                <span>€<span id="subtotal">599,99</span></span>
                            </div>
                            <div class="flex justify-between mb-2">
                            ...
                            <div class="flex justify-between font-bold text-lg mt-4">
                                <span>Totaal:</span>
                                <span>€<span id="total">599,9</span></span>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        // prodcut details
        const product = {
            name: "Quooker 22+FRCHR",
            price: 599.99,
            image: "images/quooker/quooker1.png"
        };
