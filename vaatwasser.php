...
<head>
    ...
    <title>Samsung DW60CG530B00ET</title>
        ...
        <div class="container mx-auto max-w-6xl">
            <div class="flex flex-col md:flex-row gap-8 md:gap-12">
                ...
                <div class="md:w-1/2 bg-white p-6 rounded-xl shadow-lg">
                    <img id="mainImage" src="images/vaat/vaat1.png" class="w-full h-auto object-contain rounded-lg transition-opacity duration-300">
                    <div class="flex gap-4 mt-6">
                        <div onclick="changeImage('images/vaat/vaat1.png')" class="thumbnail w-1/4 border-2 border-gray-200 rounded-lg p-1 cursor-pointer active">
                            <img src="images/vaat/vaat1.png" class="w-full h-auto">
                        </div>
                        <div onclick="changeImage('images/vaat/vaat2.png')" class="thumbnail w-1/4 border border-gray-200 rounded-lg p-1 cursor-pointer">
                            <img src="images/vaat/vaat2.png" class="w-full h-auto">
                        </div>
                        <div onclick="changeImage('images/vaat/vaat3.png')" class="thumbnail w-1/4 border border-gray-200 rounded-lg p-1 cursor-pointer">
                            <img src="images/vaat/vaat3.png" class="w-full h-auto">
                        </div>
                        <div onclick="changeImage('images/vaat/vaat4.png')" class="thumbnail w-1/4 border border-gray-200 rounded-lg p-1 cursor-pointer">
                            <img src="images/vaat/vaat4.png" class="w-full h-auto">
                        </div>
                    </div>
                </div>
                ...
                <!-- Product Details -->
                <div class="md:w-1/2">
                    <h1 class="text-3xl md:text-4xl font-bold text-white mb-2">Samsung DW60CG530B00ET</h1>
                    <div class="flex items-center mb-4">
                        <div class="flex text-yellow-400">
                            ★★★★★
                        </div>
                        <span class="text-white ml-2">(120 reviews)</span>
                    </div>
                    
                    <p class="text-2xl font-bold text-white mb-6">€1500</p>
                    ...
                    <div class="bg-white bg-opacity-20 backdrop-blur-sm rounded-xl p-6 mb-6">
                        ...
                        <p class="text-white mb-4">
                            Je wast 14 couverts vuile vaat schoon in de Samsung DW60CG530B00ET volledig geïntegreerde vaatwasser. Je plaatst al je dinerborden, pannen en schalen in de onderste korf. Heb je een extra hoge soeppan? Dan verstel je de bovenste korf omhoog, zodat je meer ruimte hebt.
                        </p>
            ...
            <div class="p-6">
                ...
                <div class="flex flex-col md:flex-row gap-8">
                    ...
                    <div class="md:w-1/3 bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="flex items-center mb-4">
                            <img id="checkoutImage" src="images/vaat/vaat1.png" class="w-16 h-16 object-cover rounded-lg mr-3">
                            <div>
                                <h4 class="font-medium" id="checkoutProduct">Samsung DW60CG530B00ET</h4>
                                <p class="text-gray-600">Aantal: <span id="checkoutQuantity">1</span></p>
                                <p class="font-bold">€<span id="checkoutPrice">1500</span></p>
                            </div>
                        </div>
                        <div class="border-t border-gray-200 pt-4">
                            <div class="flex justify-between mb-2">
                                <span>Subtotaal:</span>
                                <span>€<span id="subtotal">1500</span></span>
                            </div>
                            <div class="flex justify-between mb-2">
                            ...
                            <div class="flex justify-between font-bold text-lg mt-4">
                                <span>Totaal:</span>
                                <span>€<span id="total">1500</span></span>
                            </div>
                        </div>
                    </div>
